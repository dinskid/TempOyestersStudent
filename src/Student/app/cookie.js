...
function cookie() {
  return (
    <>
      <h6 className="font-weight-bold">What is a cookie?</h6>
      ...
      <h6 className="font-weight-bold">
        What type of cookies does Oyesters use?
      </h6>
      <p style={{ fontSize: '15px' }}>
      ...
      <h6 className="font-weight-bold">How you can manage cookies?</h6>
      <p style={{ fontSize: '15px' }}>
        ...
        Please see below for more information. Browser manufacturers provide
        help pages relating to cookie management in their products. Please see
        below for more information.
      </p>
      <ul style={{ listStyle: 'square', fontSize: '16px' }}>
        <li>Google Chrome</li>
