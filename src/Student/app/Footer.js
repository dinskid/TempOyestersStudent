  ...
  return (
    <footer className="page-footer ">
      <Row className="m-0">
        <Col md="2"></Col>
        <Col md="3" xs="12 ">
          <p className=" copy1 ml-auto" style={{ marginLeft: 'auto' }}>
            Copyright © Trainer Oyesters Training <br />
            <p
            ...
            <AiFillLinkedin
              className="fbicon"
              style={{ color: '#50ABF1', fontSize: '28px', marginTop: '-25px' }}
            />{' '}
          </p>
        </Col>
        ...
        <Col md="3" xs="12" className="text-center mt-4 text-light">
          <p className="deliver" style={{ lineHeight: '0px' }}>
            Deliver online with Oyesters
          </p>
          <img
            src={com}
          ...
          />
          <br />
          <p className="mt-2">Platform by Oyesters</p>
          <FaFacebook
            style={{
              color: '#046DE4',
              fontSize: '20px',
          ...
          />
          <AiFillLinkedin
            style={{ color: '#50ABF1', fontSize: '23px', marginTop: '-25px' }}
          />
        </Col>
      </Row>
    </footer>
